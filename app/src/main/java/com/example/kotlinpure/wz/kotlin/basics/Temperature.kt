...
* Ten en cuenta que el método String.format("%.2f", /* measurement */ ) se usa para convertir un número
en un tipo String con 2 decimales.
*/
...
fun main() {
    ...
    printFinalTemperature(
        ...
        5.toDouble()/9 * (it - 32) + 273.15
    }
}

fun printFinalTemperature(
    initialMeasurement: Double,
    initialUnit: TemperatureUnits,
    finalUnit: TemperatureUnits,
